...
set _DeploySetParametersFile=%RootPath%BuildWebDeployPackage_Release_1.0.1101.0.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%BuildWebDeployPackage_Release_1.0.1101.0.zip" (
echo "%RootPath%BuildWebDeployPackage_Release_1.0.1101.0.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%BuildWebDeployPackage_Release_1.0.1101.0.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='obj\\Debug\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='Default\ Web\ Site/Release\\App_Data$'
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%BuildWebDeployPackage_Release_1.0.1101.0.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='obj\\Debug\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='Default\ Web\ Site/Release\\App_Data$' -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%BuildWebDeployPackage_Release_1.0.1101.0.deploy-readme.txt" (
...
start notepad "%RootPath%BuildWebDeployPackage_Release_1.0.1101.0.deploy-readme.txt"
)
echo =========================================================
goto :eof
